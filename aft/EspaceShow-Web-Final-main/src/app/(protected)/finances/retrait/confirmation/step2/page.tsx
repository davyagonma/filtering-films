...
const Verification = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // router.push('/finances/retrait/confirmation/success')
            ...
            <div className="flex justify-center items-center mt-10">
                <div className="m-5">
                    <div className="text-center">
                        ...
                        <p className="mb-10">Veuillez saisir le code de vérification envoyé</p>
                    </div>
                    <form onSubmit={(e) => handleSubmit(e as any)}>
                        ...
                        <div className="flex justify-center gap-3 items-center">
                            <Link href={'/finances/retrait/confirmation/step1'}>
                                <button className="text-white rounded-lg" style={{ backgroundColor: `${colors.primary}`, padding: '13px 30px 13px 30px' }} type="button">Précédent</button>
                            </Link>
                            <button className="text-white rounded-lg" style={{ backgroundColor: `${colors.primary}`, padding: '13px 30px 13px 30px' }} type="submit">Confirmer</button>
                        </div>
                    </form>
                </div>
            </div>
